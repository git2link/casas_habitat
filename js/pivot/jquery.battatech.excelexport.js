...
(function ($) {
    ...
    $.fn.battatech_excelexport = function (options) {
        ...
        function Export(htmltable) {
            ...
            excelFile += "<meta name=Generator content='Microsoft Excel 9'>";
            excelFile += "<!--[if gte mso 9]>";
            excelFile += "<xml>";
            excelFile += "<x:ExcelWorkbook>";
            excelFile += "<x:Name>CONSEG</x:Name>";
            ...
            excelFile += "</x:ExcelWorksheets>";
            excelFile += "</x:ExcelWorkbook>";
            excelFile += "<o:DocumentProperties>";
            excelFile += "<o:Title>COSEG</o:Title>";
            excelFile += "<o:Author>Supervisión Movil</o:Author>";
            excelFile += "<o:LastAuthor>Supervisión Movil</o:LastAuthor>";
            excelFile += "<o:Company>CONSEG</o:Company>";
            excelFile += "<o:Version>1.0</o:Version>";
            excelFile += "</o:DocumentProperties>";
            excelFile += "</xml>";
            excelFile += "<![endif]-->";
            excelFile += "</head>";
