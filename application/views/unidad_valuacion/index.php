<div class="page-header">
	<h1> Unidades de Valuación <small> mantenimiento de registros </small> </h1>
	<div class="pull-left"><?= anchor('unidad_valuacion/create', 'Agregar', array('class'=>'btn btn-primary')); ?> </div>
</div>
<br>
<div class="table-responsive">
  ...
  <thead>
	...
	<tbody>
		...
		<tr>
			<td> <?= anchor('unidad_valuacion/edit/'.$registro->unidad_valuacion_k, '<i class="fa fa-edit"></i>' , array('class' => 'btn btn-secondary')); ?> </td>
