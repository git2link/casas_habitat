<div class="portlet">
        ...
        <div class="portlet-content">
            <?= form_open('cliente/insert', array('name' => 'form' , 'autocomplete' => 'off')); ?>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    <div class="form-group">
                        <?= form_label('Ocupación', 'ocupacion', array('for'=>'text-input')); ?>
                        <?= form_input(array('class' => 'form-control','type'=>'text', 'name'=>'ocupacion', 'id'=>'ocupacion', 'value'=>set_value('ocupacion'))); ?>
                    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    <div class="form-group">
                        <?= form_label('Nombre', 'nombre_conyuge', array('for'=>'text-input')); ?>
                        <?= form_input(array('class' => 'form-control','type'=>'text', 'name'=>'nombre_conyuge', 'id'=>'nombre_conyuge', 'value'=>set_value('nombre_conyuge'))); ?>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        <?= form_label('Fecha de Nacimiento', 'fecha_nacimiento_conyuge', array('for'=>'text-input')); ?>
                        <div id="dp-ex-1" class="input-group date" data-auto-close="true" data-date="1998-02-01" data-date-format="yyyy-mm-dd" data-date-autoclose="true">
                            <input class="form-control" type="text" name="fecha_nacimiento_conyuge">
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        <?= form_label('NSS', 'nss_conyuge', array('for'=>'text-input')); ?>
                        <?= form_input(array('class' => 'form-control','type'=>'text', 'name'=>'nss_conyuge', 'id'=>'nss_conyuge', 'value'=>set_value('nss_conyuge'))); ?>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        <?= form_label('RFC', 'rfc_conyuge', array('for'=>'text-input')); ?>
                        <?= form_input(array('class' => 'form-control','type'=>'text', 'name'=>'rfc_conyuge', 'id'=>'rfc_conyuge', 'value'=>set_value('rfc_conyuge'))); ?>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        <?= form_label('CURP', 'curp_conyuge', array('for'=>'text-input')); ?>
                        <?= form_input(array('class' => 'form-control','type'=>'text', 'name'=>'curp_conyuge', 'id'=>'curp_conyuge', 'value'=>set_value('curp_conyuge'))); ?>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        <?= form_label('# INE', 'no_ife_conyuge', array('for'=>'text-input')); ?>
                        <?= form_input(array('class' => 'form-control','type'=>'text', 'name'=>'no_ife_conyuge', 'id'=>'no_ife_conyuge', 'value'=>set_value('no_ife_conyuge'))); ?>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        <?= form_label('Email', 'email_conyuge', array('for'=>'text-input')); ?>
                        <?= form_input(array('class' => 'form-control','type'=>'text', 'name'=>'email_conyuge', 'id'=>'email_conyuge', 'value'=>set_value('email_conyuge'))); ?>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        <?= form_label('Teléfono', 'telefono_conyuge', array('for'=>'text-input')); ?>
                        <?= form_input(array('class' => 'form-control','type'=>'text', 'name'=>'telefono_conyuge', 'id'=>'telefono_conyuge', 'value'=>set_value('telefono_conyuge'))); ?>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        <?= form_label('Ocupación', 'ocupacion_conyuge', array('for'=>'text-input')); ?>
                        <?= form_input(array('class' => 'form-control','type'=>'text', 'name'=>'ocupacion_conyuge', 'id'=>'ocupacion_conyuge', 'value'=>set_value('ocupacion_conyuge'))); ?>
                    </div>
                </div>
            </div>
            <div class="row">
