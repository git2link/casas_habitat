    <div class="portlet">
        ...
        <div class="portlet-content">
            ...
            <?= form_open('avaluo/update' , array('name' => 'form' , 'autocomplete' => 'off') ); ?>
            <?= my_validation_errors(validation_errors()); ?>
            <?= form_hidden('avaluo_k', $registro->avaluo_k); ?>

            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        <?= form_label('Casa', 'casa_k', array('for'=>'select-input')); ?>
                        <?= form_dropdown('casa_k', $casas, $registro->casa_k , 'class="form-control"'); ?>
                    </div>
                    <div class="form-group">
                        <?= form_label('Unidad de Valuación', 'unidad_valuacion_k', array('for'=>'select-input')); ?>
                        <?= form_dropdown('unidad_valuacion_k', $unidades_valuacion, $registro->unidad_valuacion_k , 'class="form-control"'); ?>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <div id="dp-ex-1" class="input-group date" data-auto-close="true" data-date="<?= date('Y-m-d')?>" data-date-format="yyyy-mm-dd" data-date-autoclose="true">
                            <input class="form-control" type="text" name="fecha_solicitud" value="<?= $registro->fecha_solicitud ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div id="dp-ex-2" class="input-group date" data-auto-close="true" data-date="<?= date('Y-m-d')?>" data-date-format="yyyy-mm-dd" data-date-autoclose="true">
                            <input class="form-control" type="text" name="fecha_entrega_avaluo" value="<?= $registro->fecha_entrega_avaluo ?>" >
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" name="costo_avaluo" id="costo_avaluo" type="text" value="<?= $registro->costo_avaluo ?>">
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon">$</span>
                            <input class="form-control" name="base" id="base" type="text" value="<?= $registro->base ?>">
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon">$</span>
                            <input class="form-control" name="hipotetico" id="hipotetico" type="text" value="<?= $registro->hipotetico ?>">
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon">$</span>
                            <input class="form-control" name="final" id="final" type="text" value="<?= $registro->final ?>">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        ...
                        <?= form_dropdown('facturado', $sino, $registro->facturado , 'class="form-control"'); ?>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        <?= form_label('Pagado', 'pagado', array('for'=>'select-input')); ?>
                        <?= form_dropdown('pagado', $sino, $registro->pagado , 'class="form-control"'); ?>
                    </div>
                </div>
            </div>
            <div class="row">
