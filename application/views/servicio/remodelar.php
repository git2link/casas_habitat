    ...
    <div class="portlet">
        ...
        <div class="portlet-header">
          ...
          <h3>
            ...
            Prospecto para Remodelar
          </h3>

        </div> <!-- /.portlet-header -->

        <?= form_open('servicio/createremodelar', array('name' => 'form' , 'autocomplete' => 'off') ); ?>
        ...
        <div class="portlet-content">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        <?= form_label('Estado', 'estado', array('for'=>'text-input')); ?>
                        <select name="esuado_k" id="estado" value="<?= set_value('estado'); ?>" class="form-control">
                        </select>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
