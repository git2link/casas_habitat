    ...
    <div class="portlet">
        ...
        <?= form_open('servicio/createcompra', array('name' => 'form' , 'autocomplete' => 'off') ); ?>
        ...
        <div class="portlet-content">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
                        <?= form_label('Estado', 'estado_k', array('for'=>'select-input')); ?>
                        <?= form_dropdown('estado_k', $estados, 0 , 'class="form-control" id="estado_k"'); ?>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="form-group">
