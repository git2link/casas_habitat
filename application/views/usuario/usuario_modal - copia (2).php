        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a data-toggle="modal" href="#modal_disable" class="btn btn-default">Eliminar</a>
    ...
    <div id="modal_2" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div align="center">
                        <div class="tgg_1 hide" id="div_camera" align="center"></div>
                    </div>
                    <div align="center">
                ...
                <div class="modal-footer">
                    ...
                    <button id="btn_take_picture"   class="btn btn-default tgg_1 hide" >Capturar</button>
