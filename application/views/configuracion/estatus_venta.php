...
<script type="text/javascript">
  var table_1 = $('#tbl_1').DataTable({
            ...
            ajax: {
                url: "<?=base_url('configuracion/estatusventadatatable')?>",
                type: "POST"
            },
            columns: [{
                "data": "descripcion"
  ...
  $('#btn_edit_1').on('click', function(e){
    ...
    if (dta_table != undefined) {
      ...
      $('#estatus_venta_k').val(dta_table['estatus_venta_k']);
      $('.action').val('update_estatus_venta');
    }else{
